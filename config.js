...
//Info maszeh
global.owner = ["6282155796071"]
global.mods = ["6282155796071"]

global.namabot = '⏤͟͟͞͞⃟𖥂 Arra' //nama BOT Lu
global.packname = '⏤͟͟͞͞⃟𖥂 Arra'
global.author = 'Arra Chomel ◡̈⃝︎  ' //nama Owner
global.ownernya = '6282155796071'
global.linkyt = 'https://youtube.com' //link yt lu
global.linkig = 'https://instagram.com/tiaranrftria_?igshid=YmMyMTA2M2Y=' //link ig
global.linkgh = 'https://github.com/ArraChan' //link github lu
global.titlebot = `⏤͟͟͞͞⃟𖥂 WhatsApp Bot | By Arra Chan 😝`
global.wm2 = '⏤͟͟͞͞⃟𖥂 Arra' //ganti aja kalau mau
global.wm = '⏤͟͟͞͞⃟𖥂 Arra Chan'
global.colong1 = 'Ciss 📸'
global.colong2 = '⏤͟͟͞͞⃟𖥂 Arra︎'
global.kontak2 = [
['6282155796071', '⏤͟͟͞͞⃟𖥂', '𝙊𝙬𝙣𝙚𝙧', '𝐒𝐚𝐯𝐞 𝐀𝐣𝐚 𝐊𝐚𝐤, 𝐎𝐰𝐧𝐞𝐫 𝐊𝐮 𝐁𝐚𝐢𝐤 𝐊𝐨𝐤 😉', true],
]

//Biodata OWNER Bre
global.RL = 'Clarra' //Nama RL Lu
global.gender = 'Girls' //jenis kelamin lu
global.agama = 'Protestan' //agama lu
global.age = '19' //usia lu sekarang
global.kelas = 'Kuliah' //kelas lu
global.hobi = 'Anuu' //hobi lu bre
global.tempat = 'Cilodong, Depok, Jawa Barat' //tempat tinggal lu
...
//Proses berlangsung
global.wait = '_*「 ❗ 」 𝙏𝙪𝙣𝙜𝙜𝙪 𝘽𝙣𝙩𝙧 𝙔𝙖 𝙆𝙖𝙠 😅*_'
global.eror = '_*「 ❗ 」 𝙀𝙧𝙧𝙤𝙧 𝙉𝙞𝙝 𝙆𝙖𝙠 😆*_'
...
//============= callButtons =============//
global.dtc = '𝙏𝙚𝙡𝙥𝙤𝙣 𝙊𝙬𝙣𝙚𝙧'
global.phn = '3'

//============= Games ================//
global.benar = '_*「 ❗ 」 𝘽𝙚𝙣𝙚𝙧 😝*_'
global.salah = '_*「 ❗ 」 𝙎𝙖𝙡𝙖𝙝 𝙆𝙖𝙠 😆*_'
global.dikit = "_*「 ❗ 」 𝘿𝙞𝙠𝙞𝙩 𝙇𝙖𝙜𝙞 𝙆𝙖𝙠 😀*_"
